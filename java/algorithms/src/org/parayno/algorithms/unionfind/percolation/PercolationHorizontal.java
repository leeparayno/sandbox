...
public class PercolationHorizontal {
	...
	public PercolationHorizontal(int N) {
		if (N <= 0) {
	...
	public void open(int i, int j) {
		...
		if (j > 0) {
			if (isOpen(i+1,j)) {
				site1 = (j * 10) + i;
				site2 = ((j - 1) * 10) + i;
				System.out.println("site above " + i + "," + j + " is open");
		...
		if (i > 0) {
			if (isOpen(i,j+1)) {
				site1 = (j * 10) + i;
				site2 = (j * 10) + (i - 1);				
				System.out.println("site to the left of " + i + "," + j + " is open");
				System.out.println("site1:" + site1);
				System.out.println("site2:" + site2);
				quickUnion.union(site1,site2);				
			}
		...
		if (i < N - 1) {
			if (isOpen(i+2,j+1)) {
				site1 = ((j * 10) + i);
				site2 = ((j * 10) + (i + 1));				
				System.out.println("site to the right of " + i + "," + j + " is open");
				System.out.println("site1:" + site1);
				System.out.println("site2:" + site2);
				quickUnion.union(site1,site2);				
			}
		...
		if (j < N - 1) {
			if (isOpen(i+1,j+2)) {
				site1 = ((j * 10) + i);
				site2 = ((j + 1) * 10) + i;				
				System.out.println("site below " + i + "," + j + " is open");
				System.out.println("site1:" + site1);
				System.out.println("site2:" + site2);
				quickUnion.union(site1,site2);				
			}
	...
	public static void main(String[] args) {
		int M = 10;
		PercolationHorizontal perc = new PercolationHorizontal(M);
